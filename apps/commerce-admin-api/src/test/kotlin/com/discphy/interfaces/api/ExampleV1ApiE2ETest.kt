package com.discphy.interfaces.api

import com.discphy.domain.example.ExampleModel
import com.discphy.infrastructure.example.ExampleJpaRepository
import com.discphy.interfaces.api.example.ExampleV1Dto
import com.discphy.utils.DatabaseCleanUp
...
class ExampleV1ApiE2ETest @Autowired constructor(
    ...
    companion object {
        private val ENDPOINT_GET: (Long) -> String = { id: Long -> "/admin/v1/examples/$id" }
    }
    ...
    @DisplayName("GET /admin/v1/examples/{id}")
    @Nested
    inner class Get {
        ...
        fun throwsBadRequest_whenIdIsNotProvided() {
            // arrange
            val requestUrl = "/admin/v1/examples/나나"
